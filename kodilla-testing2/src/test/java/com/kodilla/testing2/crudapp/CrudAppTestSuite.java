...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://struz89.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("pstruz89@o2.pl");
        driverTrello.findElement(By.id("password")).sendKeys("Stocznia123!");
    ...
    private void deleteTestTaskTrello(String taskName) {
