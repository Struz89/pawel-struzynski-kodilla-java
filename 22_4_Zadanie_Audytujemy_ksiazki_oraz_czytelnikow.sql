...
BEGIN
    INSERT INTO BOOKS_AUD (EVENT_DATE, EVENT_TYPE, BOOK_ID, NEW_TITLE, NEW_PUBYEAR,
        ...
        VALUE(CURTIME(), 'UPDATE', NEW.BOOK_ID, NEW.TITLE, NEW.PUBYEAR, NEW.BESTSELLER,
                           OLD.BOOK_ID, OLD_TITLE, OLD_PUBYEAR, OLD_BESTSELLER);
END $$;

DELIMITER ;

UPDATE BOOKS SET TITLE = 'Pan Tadeusz'
WHERE TITLE = 'Krzyżacy';
...
VALUES (6, 'Adam', 'Nowak', 89101223456);
...
BEGIN
    INSERT INTO READERS_AUD (EVENT_DATE, EVENT_TYPE, READER_ID, NEW_FIRSTNAME, NEW_LASTNAME,
                           NEW_PESELID, OLD_FIRSTNAME, OLD_LASTNAME, OLD_PESELID)
        VALUE(CURTIME(), 'UPDATE', NEW.READER_ID, NEW.FIRSTNAME, NEW.LASTNAME, NEW.PESELID,
              OLD.READER_ID, OLD_FIRSTNAME, OLD_LASTNAME, OLD_PESELID);
END $$;

DELIMITER ;

UPDATE READERS SET FIRSTNAME = 'Jan'
